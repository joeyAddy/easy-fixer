import testimony from "@/assets/images/testimony-bg.jpg";
    ...
    <div className="container relative mx-auto md:px-6">
      <span className="[&>svg]:absolute [&>svg]:-z-10 [&>svg]:hidden [&>svg]:w-full [&>svg]:lg:block">
        <svg
          ...
          className="absolute -top-[750px] rotate-90 -left-[600px] hidden w-full transition-opacity duration-300 dark:opacity-0 lg:block"
        >
          <defs>
      ...
      <section className="text-center lg:text-left">
        ...
        <div className="py-12 px-6 md:px-12 bg-sla">
          <div className="container mx-auto xl:px-32">
            <div className="grid items-center lg:grid-cols-2">
              <div className="mb-12 md:mt-12 lg:mt-0 lg:mb-0">
                <div className="relative z-[1] block rounded-lg bg-[hsla(0,0%,100%,0.55)] shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] backdrop-blur-[25px] dark:bg-[hsla(0,0%,5%,0.7)] dark:shadow-black/20 px-6 py-14 lg:-mr-14">
              ...
              <div className="md:mb-12 lg:mb-0 hidden md:block">
                <img
                  src={testimony.src}
                  className="lg:rotate-[6deg] w-full md:h-[500px] object-cover rounded-lg shadow-lg dark:shadow-black/20"
                  alt="image"
                />
              </div>
            </div>
